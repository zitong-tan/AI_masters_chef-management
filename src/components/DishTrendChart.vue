<template>
  <div class="dish-trend-chart">
    <div class="chart-header">
      <h3 class="chart-title">菜谱创建趋势</h3>
    ...
    <div v-if="isEmpty" class="empty-state">
      ...
      <p class="empty-hint">当前时间范围内没有菜谱创建数据</p>
    </div>
...
export default {
  ...
  computed: {
    ...
    chartData() {
      ...
      return {
        labels: this.trendData.map(item => this.formatDateLabel(item.date)),
        datasets: [{
          label: '菜谱数量',
            ...
            tooltip: {
              ...
              callbacks: {
                title: (tooltipItems) => {
                  ...
                  const originalDate = this.trendData[index].date;
